...
// typemap colours
float empty[] = {0.818f, 0.801f, 0.723f, 1.0f};
//float rock[] = {0.663f, 0.627f, 0.545f, 1.0f}; // 169 160 139
float rock[] = {0.2f, 0.2f, 0.2f, 1.0f};
float grass[] =  {0.949f, 0.8f, 0.525f, 1.0f}; // {0.859f, 0.878f, 0.463f, 1.0f}; // 219 224 118
float shrubs[] = {0.435f, 0.573f, 0.49f, 1.0f}; // {0.596f, 0.702f, 0.431f, 1.0f}; // 152 179 110
float conifersparse[] = {1.0f, 0.647f, 0.012f, 1.0f}; // {0.768f, 0.796f, 0.360f, 1.0f}; // 196 203 92
float coniferdense[] = {0.788f, 0.388f, 0.145f, 1.0f}; // {0.635f, 0.655f, 0.357f, 1.0f}; // 162 167 91
float decidsparse[] = {0.509f, 0.734f, 1.0f, 1.0f}; // {0.639f, 0.819f, 0.490f, 1.0f}; // 163 209 125
float decidsdense[] = {0.173f, 0.337f, 0.549f, 1.0f}; // {0.467f, 0.6f, 0.357f, 1.0f}; // 119 153 91
...
void TypeMap::initCategoryColTable()
{
    ...
    colmap[2] = grass;
    colmap[3] = shrubs;
    colmap[4] = conifersparse;
    colmap[5] = coniferdense;
    colmap[6] = decidsparse;
    colmap[7] = decidsdense;
