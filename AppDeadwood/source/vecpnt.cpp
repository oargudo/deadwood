...
void ecosim::rayPointDist(vpPoint start, Vector dirn, vpPoint query, float &tval, float &dist)
{
    float den;
    vpPoint closest;
    Vector closevec;
...
bool ecosim::toRightOfLine(vpPoint p, vpPoint q, vpPoint t)
{
    float impval;
...
bool ecosim::insideRect(vpPoint * p, vpPoint t)
{
    bool inside = false;
...
void ecosim::formRect(vpPoint b, float w, Vector dirn, vpPoint * p)
{
    Vector left, right;
...
bool ecosim::lineCrossing(vpPoint * e1, vpPoint * e2)
{
