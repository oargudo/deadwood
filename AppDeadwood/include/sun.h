...
namespace ecosim {
    ...
    protected:
        ...
        void updateHeightMap(int wd, int ht, float scx, float scy, const float* data, bool force);
    ...
    private:
        ...
        int twidth, theight;  // dimensions of height map
        ...
        QSize fboSize = QSize(1024, 1024);
        QOpenGLFramebufferObject* fbo = nullptr;
        GLuint normalTexture = 0;    //  normal texture identifier - data generated from shader pass
        GLuint fboNormalMap = 0;     // normal map FBO
        GLuint heightmapTexture = 0; // id of heightmap texture; generated outside class

        GLenum htmapTexUnit = 0;     // height/normal map - texture units reserved
        GLenum normalMapTexUnit = 0;
